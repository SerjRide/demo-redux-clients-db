...
const generateRandomBase = async (year, profit, name) => {
  await console.log(`The process of generating data for ${year}, profit: ${profit}`)
  await axios.post(`${url}/random-orders/gen?year=${year}&profit=${profit}&name=${name}`)
}
